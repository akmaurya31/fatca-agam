...
const postarray= { email:req.body.email }
  ...
  Customer.getFatcamm(postarray.email,(err, data) => {      
    ...
    if(data!=null){ 
         ...
         console.log("c- something is bad11",data);   
      ...
      //
      console.log("c- whats is going on?")

    if (err){ 

      console.log("c- err coustomn?")
      ...
      // res.status(500).send({
      //   message:
      //     err.message || "6 Some error occurred while retrieving customers."
      // });
      ...
      console.log("the data is controller, ", data[0]);

    let urs_email_exist= data[0].email

    console.log("my email controoler ",urs_email_exist)
   

if(urs_email_exist.email!=""){

  console.log("4 agamurdddddddddddddddddddsFULL--",urs_email_exist);
}else{
  console.log("5 cccccccccccccccc--");
